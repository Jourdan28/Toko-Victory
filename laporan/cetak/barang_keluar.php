<?php
/* === laporan/cetak/barang_keluar.php === */
...
cetakHeader('LAPORAN BARANG KELUAR', $f, [
...
?>
<table class="data">
  <thead><tr><th>No</th><th>Kode</th><th>Barang</th><th>Kategori</th><th>Keluar</th><th>Stok Sebelum</th><th>Stok Sesudah</th><th>Oleh</th><th>Tanggal</th></tr></thead>
  <tbody>
  ...
  <tr>
    ...
    <td><?= number_format((int) $r['stok_sebelum']) ?></td>
